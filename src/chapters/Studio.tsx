...
import { STUDIO_NIGHTS, roomKeyFor } from '../data'
    ...
    <ChapterShell onClose={ctx.closeStudio} background="#161613" dark>
      ...
      <div style={{ position: 'relative', width: '100%', height: 'clamp(380px,66vh,780px)', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', left: 0, right: 0, bottom: 'clamp(34px,6vh,70px)', textAlign: 'center', color: '#f6efe4', padding: '0 6vw' }}>
          <div style={{ fontFamily: "'Jost',sans-serif", fontWeight: 400, fontSize: 11, letterSpacing: '0.5em', textTransform: 'uppercase', color: 'rgba(236,209,147,0.9)', marginBottom: '0.8em' }}>An evening in the house</div>
          <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontWeight: 400, fontSize: 'clamp(40px,6.4vw,92px)', lineHeight: 1, margin: 0, textShadow: '0 2px 40px rgba(0,0,0,0.5)' }}>Inside the Studio</h2>
          <div style={{ fontFamily: "'Cormorant Garamond',serif", fontStyle: 'italic', fontSize: 'clamp(19px,2.2vw,29px)', color: 'rgba(246,239,228,0.9)', marginTop: '0.5em' }}>Monthly conversations with Resident Experts.</div>
        </div>
      </div>
      ...
      <div style={{ position: 'relative', maxWidth: 880, margin: '0 auto', padding: 'clamp(50px,9vh,110px) 6vw clamp(70px,14vh,170px)', textAlign: 'center', color: 'rgba(246,239,228,0.92)' }}>
        <p style={{ fontFamily: "'Cormorant Garamond',serif", fontWeight: 300, fontSize: 'clamp(20px,2.3vw,29px)', lineHeight: 1.62, color: 'rgba(246,239,228,0.88)', maxWidth: '50ch', margin: '0 auto', textWrap: 'pretty' as React.CSSProperties['textWrap'] }}>Once a month, a Resident Expert is welcomed into Believe Studio for one evening. Not a guest speaker. Not a webinar. Someone trusted, invited into the house the way you’d invite a friend.</p>
